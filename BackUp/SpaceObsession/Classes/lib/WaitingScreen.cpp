...
Scene* WaitingScreen::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = WaitingScreen::create();
...
void WaitingScreen::construct(std::string labelString)
{
    //add screen
    ...
    //loading text
    auto label = Label::createWithBMFont("fonts/font.fnt", std::string(labelString));
    ...
    listener->onTouchBegan = CC_CALLBACK_2(WaitingScreen::onTouchBegan, this);
    listener->onTouchEnded = CC_CALLBACK_2(WaitingScreen::onTouchEnded, this);
    _eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);
}

bool WaitingScreen::onTouchBegan(cocos2d::Touch *touch, cocos2d::Event *event)
{
    return true;
}

void WaitingScreen::onTouchEnded(cocos2d::Touch *touch, cocos2d::Event *event)
{
