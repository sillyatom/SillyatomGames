...
struct  PropertyPresence_t2652339728 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PropertyPresence_t2652339728, ___value___1)); }
