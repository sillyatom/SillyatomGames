...
struct  ObjectCreationHandling_t2384618758 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ObjectCreationHandling_t2384618758, ___value___1)); }
